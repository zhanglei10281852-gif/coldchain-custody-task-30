...
import (
	...
	"github.com/zhanglei10281852-gif/coldchain-custody-base/internal/config"
	"github.com/zhanglei10281852-gif/coldchain-custody-base/internal/httpapi"
	...
	"github.com/zhanglei10281852-gif/coldchain-custody-base/internal/worker"
)
...
func run(logger *slog.Logger) error {
	...
	defer store.Close()
	services := service.New(store, clock.Real{}, cfg.SessionTTL, cfg.HandoffTTL)
